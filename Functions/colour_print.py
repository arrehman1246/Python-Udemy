...
def colour_print(text: str, *effects: str) -> None:
    ...
    """
    string_effects = "".join(effects)
    output_string = "{0}{1}{2}".format(string_effects, text, RESET)
    print(output_string)
...
colour_print("Hello, Blue and Underlined", BLUE, UNDERLINE)
colour_print("Hello, Yellow, Reverse, and Underline", YELLOW, REVERSE, UNDERLINE)
